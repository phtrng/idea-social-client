<template>
  <div>
    <navbar :minNav="navbarMinimize" :toggle="toggleConfigurator" :class="this.$store.state.isNavFixed ? this.$store.state.navbarFixed_class : ''" />
  </div>
  <div
        ...
        <div class="container-fluid">
          <div class="pt-10 row">
            <div class="pt-5 text-center col-lg-1 col-md-1 pt-lg-0 ms-lg-5">
              <a href="javascript:;" class="border-0 avatar avatar-md d-block" data-bs-toggle="tooltip" data-bs-placement="left" title="My Profile">
