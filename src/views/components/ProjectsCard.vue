          ...
          <tbody>
            <tr>
              ...
              <td class="align-middle">
                <div class="d-flex align-items-center justify-content-center">
                  ...
                  <div>
                    <vsud-progress color="info" class="mx-auto" variant="gradient" percentage="60" />
                  </div>
                </div>
              </td>
            </tr>
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  <div>
                    <vsud-avatar :img="img6" size="sm" class="me-3" alt="atlassian" />
                  </div>
                  <div class="d-flex flex-column justify-content-center">
              ...
              <td class="align-middle">
                <div class="d-flex align-items-center justify-content-center">
                  ...
                  <div>
                    <vsud-progress color="info" class="mx-auto" variant="gradient" percentage="10" />
                  </div>
                </div>
              </td>
            </tr>
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  <div>
                    <vsud-avatar :img="img9" size="sm" class="me-3" alt="team7" />
                  </div>
                  <div class="d-flex flex-column justify-content-center">
              ...
              <td class="align-middle">
                <div class="d-flex align-items-center justify-content-center">
                  ...
                  <div>
                    <vsud-progress color="success" class="mx-auto" variant="gradient" percentage="100" />
                  </div>
                </div>
              </td>
            </tr>
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  <div>
                    <vsud-avatar :img="img12" class="me-3" size="sm" alt="spotify" />
                  </div>
                  <div class="d-flex flex-column justify-content-center">
            ...
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  <div>
                    <vsud-avatar :img="img17" rounded-circle class="me-3" size="sm" alt="jira" />
                  </div>
                  <div class="d-flex flex-column justify-content-center">
              ...
              <td class="align-middle">
                <div class="d-flex align-items-center justify-content-center">
                  ...
                  <div>
                    <vsud-progress color="info" class="mx-auto" variant="gradient" percentage="25" />
                  </div>
                </div>
              </td>
            </tr>
            <tr>
              <td>
                <div class="d-flex px-2 py-1">
                  <div>
                    <vsud-avatar :img="img19" class="me-3" size="sm" alt="invision" />
                  </div>
                  <div class="d-flex flex-column justify-content-center">
              ...
              <td class="align-middle">
                <div class="d-flex align-items-center justify-content-center">
                  ...
                  <div>
                    <vsud-progress color="info" class="mx-auto" variant="gradient" percentage="40" />
                  </div>
                </div>
              </td>
            </tr>
