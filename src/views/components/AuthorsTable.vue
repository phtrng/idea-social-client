    ...
    <div class="card-header pb-0">
      ...
      <div class="btn-toolbar d-flex align-items-start justify-content-between" role="toolbar">
        <div class="btn-group mb-3" role="group">
          <vsud-button color="secondary" variant="outline" class="mb-auto"><i class="fa fa-plus"></i> Add</vsud-button>
        </div>
              ...
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    ...
                    <p class="text-xs text-secondary mb-0">alexa@example.com</p>
                  </div>
                </div>
              </td>
              <td>
              ...
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    ...
                    <p class="text-xs text-secondary mb-0">laurent@example.com</p>
                  </div>
                </div>
              </td>
              <td>
              ...
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    ...
                    <p class="text-xs text-secondary mb-0">richard@example.com</p>
                  </div>
                </div>
              </td>
              <td>
              ...
              <td>
                <div class="d-flex px-2 py-1">
                  ...
                  <div class="d-flex flex-column justify-content-center">
                    ...
                    <p class="text-xs text-secondary mb-0">miriam@example.com</p>
                  </div>
                </div>
              </td>
              <td>
